    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-md mx-auto px-4 pb-28">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <button className="w-11 h-11 rounded-full bg-card border border-border shadow-md flex items-center justify-center text-foreground hover:opacity-80 transition-opacity">
