...
export default function LoginPage() {
  ...
  if (isSignUp) {
    return <SignupFlow onSwitchToLogin={() => setIsSignUp(false)} />;
  }
        ...
        <div className="max-w-md w-full mx-auto flex-1 flex flex-col">
          ...
          <form onSubmit={handleLogin} className="space-y-5 flex-1">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-xl bg-[#D9FF51] text-[#0a0a0a] font-semibold hover:bg-[#c5eb3a] transition-colors text-[15px]"
            >
